                ...
                <div class="content">
                    <div class="tb">
                        <div class="container-form">
                            <form action="../../actions/action_add.php" method="POST" id="form" class="form-action">
                                <div class="form">
                                    <div class="tittle">
                                        <h1>Tambah Data</h1>
                                    ...
                                    <div class="parent">
                                        <div class="input">
                                            <div class="group">
                                                ...
                                                <input type="text" name="name" placeholder="Masukan Nama Lengkap" id="name" value="" required>
                                            </div>
                                            <div class="group">
