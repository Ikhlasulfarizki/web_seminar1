                ...
                <div class="container-content">
                    <div class="content">
                        <div class="title-content">
                            <h1>Data User</h1>
                            <a href="table_role/tambah_role">Tambah Role</a>
                        </div>
                        <div class="tb">
                            <div class="table">
                                <table id="tables" class="display nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-priority="3">Permission</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="actions-td">
                                                    <a href="table_role/<?= $role['id'] ?>" class="edit"> <i class="fa-regular fa-pen-to-square"></i></a>
                                                    <a data-id="<?= $role['id'] ?>" data-name="<?= $role["role_name"]?>" class="del"><i class="fa-regular fa-trash-can"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
