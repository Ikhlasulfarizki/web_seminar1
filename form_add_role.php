                ...
                <div class="content">
                    <div class="tb">
                        <div class="container-form">
                            <form action="../../actions/action_add_role.php" method="POST" id="form" class="form-action">
                                <div class="form">
                                    <div class="tittle">
                                        <h1>Tambah Data</h1>
                                        ...
                                        <div class="input-role">
                                            ...
                                            <div class="group">
                                                ...
                                                <div class="check-box-role">
                                                    <div class="cb-gap">
                                                        <input type="checkbox" class="cb-role" name="permission[]" value="user">
                                                        <label for="">User</label>
                                                    </div>
                                                    <div class="cb-gap">
                                                        <input type="checkbox" class="cb-role" name="permission[]" value="role">
                                                        <label for="">Role</label>
                                                    </div>
                                                    <div class="cb-gap">
                                                        <input type="checkbox" class="cb-role" name="permission[]" value="create seminar">
                                                        <label for="">Create&nbsp;Seminar</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
